        ...
        <div className="space-y-3">
          {challenges.map((ch, index) => {
            ...
            return (
              ...
              >
                <Card
                  className="p-5 bg-white border-slate-200/90 shadow-sm hover:shadow-md hover:border-cyan-400 transition-all rounded-2xl cursor-pointer flex flex-col sm:flex-row sm:items-center justify-between gap-4 group"
                  onClick={() => navigate(`/challenges/${ch.id}`)}
                >
                  <div className="space-y-1.5 flex-1">
                    <div className="flex items-center gap-2.5 flex-wrap">
                      <span className="text-base font-extrabold text-slate-900 group-hover:text-cyan-600 transition-colors">
                        {ch.title}
                      </span>
                      ...
                      {isSolved ? (
                        ...
                        <span className="inline-flex items-center gap-1 text-[10px] font-mono font-bold text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full border border-amber-200">
                          <Play className="w-2.5 h-2.5 fill-amber-600" />
                          ATTEMPTED
                        </span>
                      ) : null}
                    </div>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-6 shrink-0 font-mono">
                    <div className="text-right">
                      <span className="text-sm font-black text-cyan-600 flex items-center justify-end gap-1">
                    ...
                    <div className="w-9 h-9 rounded-xl bg-slate-100 group-hover:bg-cyan-50 group-hover:text-cyan-600 text-slate-400 flex items-center justify-center transition-colors">
