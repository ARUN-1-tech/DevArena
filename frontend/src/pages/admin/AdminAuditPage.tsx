                ...
                logs.map((log) => (
                  <tr key={log.id} className="hover:bg-slate-800/40 transition">
                    ...
                    <td className="px-5 py-3.5">
                      <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-slate-800 border border-slate-700 font-mono text-[11px] font-medium text-slate-200">
                        {getActionIcon(log.action)}
                        <span>{log.action}</span>
                      </div>
                    </td>
                    <td className="px-5 py-3.5">
                      <div className="font-mono text-xs text-slate-300">{log.targetId}</div>
                      <div className="text-[10px] text-slate-500 uppercase">{log.targetType}</div>
                    </td>
                    <td className="px-5 py-3.5 text-slate-400 max-w-md truncate">
                      {log.metadata || '—'}
                    </td>
                  </tr>
                ))
