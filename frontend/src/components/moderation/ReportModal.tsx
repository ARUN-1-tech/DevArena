          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-semibold text-slate-100">Report {targetType}</h3>
                  <p className="text-xs text-slate-400">
                    Target: <span className="font-medium text-slate-300">{targetName || targetId}</span>
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-xs text-slate-200 focus:outline-none focus:border-rose-500 transition"
                >
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 px-4 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-white text-xs font-medium transition disabled:opacity-50"
                >
